...
void surusiuoti(std::list<studentas>& grupe, std::list<studentas>& vargsiukai, const std::string& pagalRusiuoti) {
...
void isvedimas(const list<studentas>& grupe, const string& failas) {
